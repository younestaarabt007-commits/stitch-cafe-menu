const products = [
    { id: "cold_1", name: "Cola", description: "Classic cola", price: 4.00, image: "../images/sub catégorie images/cold drinks/Coka Cola.jpg", category: "soda" },
    { id: "cold_2", name: "Sprite", description: "Lemon lime soda", price: 4.00, image: "../images/sub catégorie images/cold drinks/Sprite.jpg", category: "soda" },
    { id: "cold_3", name: "Hawei", description: "Energy drink", price: 5.00, image: "../images/sub catégorie images/cold drinks/Hawei.jpg", category: "soda" },
    { id: "cold_4", name: "Mokhito", description: "Refreshing mint cocktail", price: 8.00, image: "../images/sub catégorie images/cold drinks/Mokhito.jpg", category: "cocktail" },
    { id: "cold_5", name: "Wild Berry Drink", description: "Mixed berry refreshment", price: 7.00, image: "../images/sub catégorie images/cold drinks/Wild Berry Drink.jpg", category: "cocktail" },
    { id: "cold_6", name: "Cold Pomelo", description: "Citrus cold drink", price: 6.50, image: "../images/sub catégorie images/cold drinks/Cold Ponplemouse .jpg", category: "cocktail" },
    { id: "cold_7", name: "Miami Cocktail", description: "Tropical cocktail", price: 9.00, image: "../images/sub catégorie images/cold drinks/Miami Coktail.jpg", category: "cocktail" },
    { id: "cold_8", name: "Tropical Drink", description: "Exotic tropical mix", price: 7.50, image: "../images/sub catégorie images/cold drinks/Tripical Drink.jpg", category: "cocktail" },
    { id: "cold_9", name: "Purple Berry Cocktail", description: "Berry and lime cocktail", price: 8.50, image: "../images/sub catégorie images/cold drinks/Coktail purple berry lime .jpg", category: "cocktail" }
];
