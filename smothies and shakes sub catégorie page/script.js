const products = [
  { id: 1, name: "Berry Burst", description: "Strawberry, blueberry, yogurt", price: 5.20, image: "https://images.unsplash.com/photo-1502741119870-16c6b8d5fbb4?q=80&w=500&auto=format&fit=crop", category: "smoothie" },
  { id: 2, name: "Green Power", description: "Spinach, apple, banana", price: 5.00, image: "https://images.unsplash.com/photo-1505250469679-203ad9ced0cb?q=80&w=500&auto=format&fit=crop", category: "smoothie" },
  { id: 3, name: "Classic Chocolate Shake", description: "Rich cocoa, creamy base", price: 5.20, image: "https://images.unsplash.com/photo-1542444459-db9b6f23e273?q=80&w=500&auto=format&fit=crop", category: "shake" },
  { id: 4, name: "Vanilla Bean Shake", description: "Madagascar vanilla, smooth", price: 5.00, image: "https://images.unsplash.com/photo-1542444453-9e3048fabb17?q=80&w=500&auto=format&fit=crop", category: "shake" },
];
