const products = [
    { id: "latte_1", name: "Classic Latte", description: "Double shot, steamed milk", price: 4.80, image: "/assets/latte-classic.jpg", category: "classic" },
    { id: "latte_2", name: "Signature Oat Latte", description: "Creamy & Sustainable", price: 6.50, image: "/assets/latté/c98d046bf1085bc59f77893bf9779244.jpg", category: "plant-based" },
    { id: "latte_3", name: "Vanilla Bean", description: "House vanilla bean syrup", price: 5.75, image: "/assets/latté/413ec74a68481ef01743fe316c867c48.jpg", category: "flavored" },
    { id: "latte_4", name: "Caramel Macchiato", description: "Buttery caramel drizzle", price: 6.25, image: "/assets/latte-caramel-macchiato.jpg", category: "flavored" },
    { id: "latte_5", name: "Spanish Latte", description: "Condensed milk & espresso", price: 5.50, image: "/assets/latté/Café Crème.jpg", category: "classic" },
    { id: "latte_6", name: "Rose Water Latte", description: "Delicate floral infusion", price: 6.00, image: "/assets/latté/f44e75c15bafa88216ef43d6600177e0.jpg", category: "flavored" },
    { id: "latte_7", name: "Iced Matcha Latte", description: "Ceremonial grade green tea", price: 6.25, image: "/assets/tea/8de4ad2c0c676dc76030cf5c8c8fad50.jpg", category: "iced" },
    { id: "latte_8", name: "Hazelnut Latte", description: "Rich nutty profile", price: 5.75, image: "/assets/latté/c3458b0388f7f10df2f6949c1e7e73d2.jpg", category: "flavored" },
    { id: "latte_9", name: "Pumpkin Spice Latte", description: "Seasonal spices & puree", price: 5.40, image: "/assets/latte-pumpkin-spice.jpg", category: "seasonal" }
];
